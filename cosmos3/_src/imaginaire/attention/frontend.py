...
from cosmos3._src.imaginaire.attention.backends import choose_backend, choose_multi_dim_backend
from cosmos3._src.imaginaire.attention.checks import (
...
from cosmos3._src.imaginaire.attention.flash2 import flash2_attention
from cosmos3._src.imaginaire.attention.flash3 import flash3_attention
from cosmos3._src.imaginaire.attention.masks import CausalType
from cosmos3._src.imaginaire.attention.natten import natten_attention, natten_multi_dim_attention
...
def attention(
    ...
    dimension. Sequence lengths for different batches can be provided in two ways:
        ...
        2. `cumulative_seqlen_{Q,KV}` and `max_seqlen_{Q,KV}` (more efficient):
            ...
            parameters:
                ```python3
                from cosmos3._src.imaginaire.attention.varlen import generate_varlen_parameters
                (
                    cumulative_seqlen_Q,
...
def multi_dimensional_attention_varlen(
    ...
    **Requires NATTEN >= 0.21.9.dev0 and either Hopper or Blackwell DC-class architecture**
    ...
    from cosmos3._src.imaginaire.attention.natten import natten_supported
    ...
    from cosmos3._src.imaginaire.attention.natten.functions import natten_multi_dim_attention_varlen
