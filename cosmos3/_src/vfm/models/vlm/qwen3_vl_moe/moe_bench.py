...
Usage:
    ...
    python -m cosmos3._src.vfm.models.vlm.qwen3_vl_moe.moe_bench

    # Forward + backward:
    python -m cosmos3._src.vfm.models.vlm.qwen3_vl_moe.moe_bench --backward

    # Compare grouped_mm vs naive:
    python -m cosmos3._src.vfm.models.vlm.qwen3_vl_moe.moe_bench --compare

    # Disable torch.compile:
    python -m cosmos3._src.vfm.models.vlm.qwen3_vl_moe.moe_bench --no-compile
    ...
    python -m cosmos3._src.vfm.models.vlm.qwen3_vl_moe.moe_bench --profile

    # Profile to a custom directory:
    python -m cosmos3._src.vfm.models.vlm.qwen3_vl_moe.moe_bench --profile --profile-dir ./my_traces

    # All options:
    python -m cosmos3._src.vfm.models.vlm.qwen3_vl_moe.moe_bench --help
"""
...
from cosmos3._src.vfm.models.vlm.qwen3_vl_moe.moe import (
