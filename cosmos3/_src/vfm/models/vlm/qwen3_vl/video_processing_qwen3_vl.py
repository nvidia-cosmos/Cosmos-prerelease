...
# This is adapted from src/transformers/models/qwen3_vl/video_processing_qwen3_vl.py.
        ...
        **kwargs,
        ...
        for shape, stacked_videos in grouped_videos.items():
            ...
            if do_resize:
                ...
                stacked_videos = stacked_videos.view(B * T, C, H, W)  # [B*T,C,H,W]
        ...
        for shape, stacked_videos in grouped_videos.items():
            ...
            if patches.shape[1] % temporal_patch_size != 0:
                repeats = patches[:, -1:].repeat(1, temporal_patch_size - 1, 1, 1, 1)  # [B,temporal_patch_size-1,C,H,W]
                patches = torch.cat([patches, repeats], dim=1)  # [B,T_padded,C,H,W]
            ...
            patches = patches.view(
                ...
                merge_size,
                patch_size,
            )  # [B,grid_t,temporal_patch_size,C,grid_h//merge_size,merge_size,patch_size,grid_w//merge_size,merge_size,patch_size]
            patches = patches.permute(
                0, 1, 4, 7, 5, 8, 3, 2, 6, 9
            )  # [B,grid_t,grid_h//merge_size,grid_w//merge_size,merge_size,merge_size,C,temporal_patch_size,patch_size,patch_size]
            flatten_patches = patches.reshape(
                batch_size,
                grid_t * grid_h * grid_w,
                channel * temporal_patch_size * patch_size * patch_size,
            )  # [B,grid_t*grid_h*grid_w,C*temporal_patch_size*patch_size*patch_size]
        ...
        pixel_values_videos = torch.cat(
            processed_videos, dim=0
        )  # [total_videos,N_tokens,C*temporal_patch_size*patch_size*patch_size]
        video_grid_thw = torch.tensor(processed_grids)  # [total_videos,3]
        data = {
