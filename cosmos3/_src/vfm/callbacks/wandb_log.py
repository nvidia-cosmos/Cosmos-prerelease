...
"""
Copied from projects/cosmos/reason1/callbacks/wandb_log.py remove loss_per_token related code
"""
...
class WandbCallback(Callback):
    ...
    def on_training_step_end(
        ...
        # All elements within a batch have the same dataset name (image or video)
