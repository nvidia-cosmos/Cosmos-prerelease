...
def get_sample_data(
    ...
    *,
    ...
    match sample_args.action_mode:
        case ActionMode.FORWARD_DYNAMICS | ActionMode.POLICY | ActionMode.INVERSE_DYNAMICS:
            ...
            return get_action_sample_data(
                ...
                action_mode=sample_args.action_mode,
        ...
        case ActionMode.IMAGE2VIDEO | None:
            pass
        case _:
            assert_never(sample_args.action_mode)
