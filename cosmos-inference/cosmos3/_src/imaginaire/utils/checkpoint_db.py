...
if not INTERNAL:
    from cosmos3._src.imaginaire.utils.checkpoint_db import download_checkpoint
...
from cosmos3._src.imaginaire.flags import EXPERIMENTAL_CHECKPOINTS, INTERNAL, StrEnum
