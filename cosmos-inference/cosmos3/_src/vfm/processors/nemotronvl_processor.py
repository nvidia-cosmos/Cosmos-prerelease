...
from cosmos3._src.vfm.processors.base import BaseVLMProcessor, convert_string_content_to_list_content
...
if __name__ == "__main__":
    """
    PYTHONPATH=. python3 cosmos3/_src/vfm/processors/nemotronvl_processor.py
    """
