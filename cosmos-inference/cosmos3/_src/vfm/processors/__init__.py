...
from cosmos3._src.vfm.processors.base import BaseVLMProcessor
from cosmos3._src.vfm.processors.nemotron3densevl_processor import Nemotron3DenseVLProcessor
from cosmos3._src.vfm.processors.nemotronvl_processor import NemotronVLProcessor
from cosmos3._src.vfm.processors.qwen3vl_processor import Qwen3VLProcessor
from cosmos3._src.vfm.tokenizers.tokenization_qwen2 import Qwen2Tokenizer
from cosmos3._src.vfm.utils.vlm.pretrained_models_downloader import maybe_download_hf_model_from_s3

_VARIANT_TO_CREDENTIALS = {
    "s3": ("credentials/s3_training.secret", "bucket"),
    "gcp": ("credentials/gcp_checkpoint.secret", "bucket"),
